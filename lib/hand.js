...
(function() {
  ...
  Hand = function() {
    var best, cards, j, len, result, set, sets;
  ...
  _calculate = function(cards) {
    var card, flush, i, j, l, len, len1, len2, m, r, r1, r2, rank, ranked, result, str, straight, v, val;
    ranked = [];
    flush = true;
    ...
    for (l = 0, len1 = ranked.length; l < len1; l++) {
      ...
      v = r < 10 ? '0' : '';
      v += r;
      for (m = 0, len2 = rank.length; m < len2; m++) {
        card = rank[m];
        str += v;
      }
    }
